...
const NewsCard = ({ state, url, title, content, image_url, result }) => {
  return (
    <Link to={"/NewsPageDetail/" + encodeURIComponent(url)} name="card-container" className='w-[300px] h-[310px] bg-white px-4 py-5 rounded-2xl drop-shadow-2xl'>
      <Image src= { image_url } alt='News Image'  className='object-cover rounded-2xl w-full h-[140px]'/>
