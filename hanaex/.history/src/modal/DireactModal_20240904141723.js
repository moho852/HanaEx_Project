  ...
  return (
    ...
    <ModalContent className="px-6">
      ...
      <div className='flex justify-center gap-1'>
        <Text className="flex font-semibold justify-center text-2xl">{changeState}</Text>
        <Text className="flex font-semibold justify-center text-2xl">{exchangeValue}을</Text>
      </div>
