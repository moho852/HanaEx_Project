  ...
  return (
    ...
    <ModalContent className="px-6">
      ...
      <div className='flex justify-center gap-1'>
        <Text className="flex text-slate-600 font-semibold justify-center text-2xl">{changeState}</Text>
        <Text as='mark' className="flex font-semibold justify-center text-2xl">{exchangeValue}</Text>
        <Text className="flex text-slate-600 font-semibold justify-center text-2xl">을</Text>
      </div>
      {/* 2번줄 */}
      <div className='flex justify-center gap-1'>
        <Text as='mark' className="flex font-semibold justify-center text-2xl">{calculatedValue}</Text>
        <Text className="flex text-slate-600 font-semibold justify-center text-2xl">원에 샀습니다</Text>
      </div>
