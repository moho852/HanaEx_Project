...
//   // const handleDepositChange = (valueString) => {
...
const ModifyModal = ({
  ...
  const [requestAmount, setRequestAmount] = useState(selectedTransaction.request_amount || "");
  ...
  return (
    <ModalContent>
      <ModalHeader>트랜잭션 수정</ModalHeader>
      <ModalCloseButton />
      <ModalBody>
        <FormControl>
          <FormLabel>요청 금액 (KRW)</FormLabel>
          <Input
            type="number"
            value={requestAmount}
