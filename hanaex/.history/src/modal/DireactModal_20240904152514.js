...
const DireactModal = ({onClose, onPurchaseClick, exchangeValue, calculatedValue, currentInvestPrice, currentSellPrice, selected, changeState }) => {
  ...
  return (
    ...
    <ModalContent className="px-6">
      ...
      {/* 마지막 부분 */}
      <div className='bg-slate-100 rounded-md mx-5 mt-2 py-4'>
        <Text className="leading-0 flex text-slate-600 justify-center text-lg mr-1">환율(Spread) 80% 우대로</Text>
        <Text className="leading-0 flex text-red-600 font-normal justify-center text-lg mr-1">10원 더 싸게 샀어요!</Text>
      </div>
