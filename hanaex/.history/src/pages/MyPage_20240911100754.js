              ...
              <TabPanel>
                ...
                <div className="flex flex-col items-start ml-3">
                  ...
                  >
                    ...
                    <div className='flex justify-between'>
                      <Text className="text-xl font-medium">외화대가외화금액</Text>
                      <div className='flex gap-1'>
                        <Image className='w-[24px] h-[24px]' src='/image/usd_flag.png' >
                        </Image>
                    ...
                    <div className='flex justify-between'>
                      ...
                      <Text className="text-xl font-medium">16,093</Text>
                    </div>

                    <div className='flex justify-between'>
                      <Text className="text-xl font-medium">예상적용환율</Text>
                      <Text className="text-xl font-medium">1341.13</Text>
                    </div>
