  ...
  return (
    <>
      <div className="w-[960px] flex flex-col py-1 px-10 mt-10">
        ...
        <div className="w-full flex justify-center py-5 rounded-2xl" style={{boxShadow: "0 3px 13px rgba(0, 0, 0, 0.2)"}}>
        ...
        <div className='w-full flex justify-center px-10 rounded-2xl' style={{boxShadow: "0 3px 13px rgba(0, 0, 0, 0.2)"}}>
          <WordCloudComponent words={words} />
        </div>
        <TitleText title="언급량" />
        <div className='w-full flex justify-center px-10 py-10 rounded-2xl' style={{boxShadow: "0 3px 13px rgba(0, 0, 0, 0.2)"}}>
          <NewsBarChart />
        </div>
