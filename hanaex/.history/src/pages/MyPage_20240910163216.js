          ...
          <Tabs position="relative" variant="unstyled">
            ...
            <TabPanels>
              <TabPanel>
                ...
                {/* 거래 내역 */}
                <TransactionAccount 
                  currency_code={transactionsData[0].currency_code}
                  transaction_date={transactionsData[0].transaction_date}
                  transaction_type={transactionsData[0].transaction_type}
                  withdrawal_amount={transactionsData[0].withdrawal_amount}
                />
              </TabPanel>
