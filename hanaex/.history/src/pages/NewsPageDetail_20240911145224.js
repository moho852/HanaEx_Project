        ...
        <div className="my-6">
          {fulltext === true
            ? paragraphs.map((paragraph, index) => (
                <Text key={index} className="chakra-text css-rszk63" name="full-text" style={{ marginBottom: '1.5rem' }}>
                  {paragraph}
                </Text>
              ))
            : splitByPunctuation(truncateText(consumData.content)).map((paragraph, index) => (
                <Text key={index} className="chakra-text css-rszk63" name="summary-text" style={{ marginBottom: '1.5rem' }}>
                  {paragraph}
                </Text>
              ))}
        </div>
