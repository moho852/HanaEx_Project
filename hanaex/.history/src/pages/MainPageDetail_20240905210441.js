  ...
  return (
    <div className="w-[960px] flex flex-col py-1 px-10">
      ...
      <div className="flex flex-col items-center bg-white rounded-lg py-5 drop-shadow-2xl">
        <div className="flex justify-between w-full px-20 mt-2">
          <div className="flex gap-1">
            <Text className='text-slate-500'>고시회차</Text>
            <Text className='text-slate-500'>458</Text>
          </div>
        ...
        <div className='border border-slate-600 w-full'></div>
