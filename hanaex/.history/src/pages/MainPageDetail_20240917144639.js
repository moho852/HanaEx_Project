        ...
        <div name="right-section" className="bg-slate-50 flex-1">
          ...
          <div name="1-2" className="bg-slate-400 h-[600px] rounded-xl mt-6 py-3 px-2">
            ...
            <div className='px-3'>
              ...
              <div className='flex'>
                <Text className='w-[24px] h-[24px] rounded-full bg-slate-500 text-center mr-1'>1</Text>
              ...
              <div className='flex'>
                <Text className='w-[24px] h-[24px] rounded-full bg-slate-500 text-center'>1</Text>
                <Text>미국 달러화 강세와 금리 정첵</Text>
              </div>
              <Text>2024년에도 미국 연방준비제도의 금리 인상이 달러화 강세를 지속시킬 것으로 예상됩니다. 이는 다른 주요 통화 대비 달러화의 수요를 증가시키고, 특히 신흥국 통화에 압박을 가할 것입니다​.</Text>        
              <div className='flex'>
