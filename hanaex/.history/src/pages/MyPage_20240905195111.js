            ...
            <TabPanels>
              ...
              <TabPanel>
                ...
                <div className="bg-white rounded-2xl px-8 py-6 mt-4">
                  ...
                  <Text className='flex justify-center w-[60px] border border-red-600 rounded-sm'>살래요</Text>
                    <div className="flex items-center my-2">
                      <Image
                        src="/image/usd_flag.png"
                        className="h-[34px] w-[34px]"
                      ></Image>
                      <Text className="ml-3 font-medium text-xl">
                        USD
                      </Text>
                    </div>
                    <Text>거래완료</Text>
                  ...
                  <div className='flex justify-between'>
                    <div className='flex justify-between'>
                      ...
                      <Text className='text-lg'>1,346.92</Text>
                    </div>
                    
                    <Text>2024-08-19 22:37</Text>
                  </div>
