          ...
          <Tabs position="relative" variant="unstyled">
            ...
            <TabPanels>
              <TabPanel>
                ...
                {/* 거래 내역 */}
                <TransactionAccount 
                  currency_code={accountsData[0].currency_code}
                  transaction_date={accountsData[0].transaction_date}
                  transaction_type={accountsData[0].transaction_type}
                  withdrawal_amount={accountsData[0].withdrawal_amount}
                />
              </TabPanel>
