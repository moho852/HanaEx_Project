      ...
      <div name="gpt-box" className="bg-[#EAF2EF] px-6 py-4 rounded-2xl mb-4">
        {gpttext === true ? (
          ...
          <Text>{consumData.news_summary}</Text>
            <div className='bg-green-200 rounded-2xl px-6 py-4 my-4'>
              <div className='flex items-end gap-1'>
                <Text className='font-semibold text-xl leading-0 py-2'>AI 분석 포인트</Text>
                <Image
              ...
              <Text>{consumData.news_analysis}</Text>
            </div>
          </>
        ) : (
