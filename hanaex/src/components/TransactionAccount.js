...
// const TransactionAccount = ({ currency_code, transaction_date, transaction_type, withdrawal_amount, deposit_amount, onTransaction }) => {
...
//   // 거래에 따른 잔액 변화를 처리
//   useEffect(() => {
//     const amount = transaction_type === "buy" ? withdrawal_amount : deposit_amount;
//     onTransaction(transaction_type, amount); // 부모 컴포넌트에 거래 정보를 전달하여 잔액 업데이트
//   }, [transaction_type, withdrawal_amount, deposit_amount, onTransaction]);
...
//       </Text>
//       <Text name="balance" className="flex justify-end">688,454원</Text>
